...
class MultiScaleRandomCrop(object):
    ...
    def __call__(self, img):
        ...
        x1 = self.tl_x * (image_width - int(image_width * self.scale))
        y1 = self.tl_y * (image_height - int(image_height * self.scale))
        x2 = x1 + int(image_width * self.scale)
        y2 = y1 + int(image_height * self.scale)
...
class RandomCrop(object):
    ...
    def __call__(self, img):
        ...
        x1 = self.tl_x * (image_width - self.size[0])
        y1 = self.tl_y * (image_height - self.size[1])
        x2 = x1 + self.size[0]
        y2 = y1 + self.size[1]
